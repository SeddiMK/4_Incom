(() => {
    ...
    if (secondary) secondary.addEventListener("click", (function(e) {
        filterSelection("secondary");
    }));
    if (newBuildings) newBuildings.addEventListener("click", (() => {
        filterSelection("newBuildings");
    }));
    if (rent) rent.addEventListener("click", (() => {
        filterSelection("rent");
    }));
    if (house) house.addEventListener("click", (() => {
